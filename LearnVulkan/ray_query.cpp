...
void VkRayTracingApplication::initVulkan(Scene* scene)
{
    ...
    Pipeline pip_tmp;
    pip_tmp.renderPass = renderPass;
    createGraphicsPipeline(pip_tmp, "basic.vert.spv", "basic.frag.spv");
    pipelineLayout = pip_tmp.pipelineLayout;
    graphicsPipeline = pip_tmp.graphicsPipeline;

    pip_tmp.renderPass = renderPass_indierctLgt;
    createGraphicsPipeline(pip_tmp, "basic.vert.spv", "basic_indirectLgt.frag.spv");
    pipelineLayout_indierctLgt = pip_tmp.pipelineLayout;
    graphicsPipeline_indierctLgt = pip_tmp.graphicsPipeline;
